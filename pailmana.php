...
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        ?>
        <div class="path">
        <center><br><br><br><img src="https://4.bp.blogspot.com/-RXYYgWJbgQM/XYJX3Aght9I/AAAAAAAAEZU/XRvt_EHFw1QeIuuXoTg5ESyuF5hce63RgCLcBGAsYHQ/s640/yuru-yuri-mini-2.jpg" width="70%"/></center>
            <form action="" method="post" style="margin:10px;text-align:center">
                <input name="fm_usr" value="" placeholder="Username" required>
                <br><input type="password" name="fm_pwd" value="" placeholder="Password" required>
